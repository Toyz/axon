...
func RegisterRoutes(e *echo.Echo, healthcontroller *HealthController, indexcontroller *IndexController, productcontroller *ProductController, sessioncontroller *SessionController, usercontroller *UserController, authmiddleware *AuthMiddleware, loggingmiddleware *LoggingMiddleware) {
